...
export const SideNavItem: React.FC<{
    ...
    logout = false
        ...
        const itemClass = cn(
            "cursor-pointer font-inter relative flex items-center whitespace-nowrap rounded-md text-sm transition-all duration-300",
            isActive
                ...
                >
                  <div
                    ...
                    className={cn(
                      ...
                      "hover:bg-white group-hover:text-neutral-800",
                    )}
                  >
                    {icon}
