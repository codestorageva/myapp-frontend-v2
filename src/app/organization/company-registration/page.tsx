...
const CompanyRegistration = () => {
    ...
    const [regDetails, setRegDetails] = useState({ companyName: '', ownerName: '', alternativeMobileNo: '', cinNo: '', mobileNo: '', logo: null, email: '', addressLine1: '', addressLine2: '', addressLine3: '', state1: '', city1: '', pincode1: '', shippingAddressLine1: '', shippingAddressLine2: '', shippingAddressLine3: '', shippingState: '', shippingCity: '', shippingPincode: '', panNo: '', gstNo: '', serviceDes: '', accountHolderName: '', bankName: '', branchName: '', accountNo: '', IFSC: '', bankAddress: '', industry: '', password: '' })
    const steps = [
            ...
            <OrgLayout showSidebar={false} transparentBg>
                <div className='relative flex flex-col w-full h-full p-5'>
                    <div className='w-full flex flex-col h-screen items-center'>
                        <h1 className="text-3xl font-bold text-center text-black mb-10">{'Organization Registration'}</h1>
