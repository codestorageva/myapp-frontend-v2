...
// import { getAllInvoiceById, InvoiceData } from '../../generate-invoice/generate-invoice';
...
import PreviewInvoice from "@/app/component/view_invoice";

// type Props = {
//     copyLabel?: string;
//     params?: Promise<{ id: string }>;
// }
// const PreviewInvoice: FC<Props> = ({ copyLabel, params }) => {
...
//                                     <div className="col-span-8 px-3 py-1 leading-relaxed min-h-[8rem]">
//                                         <p className="font-semibold underline mb-1">Terms & Conditions :</p>
//                                         {data?.customer.terms}
//                                         <br />
//                                     </div>

//                                     {/* Right side with fixed footer */}
//                                     <div className="col-span-4 p-2 flex flex-col justify-between min-h-[8rem] text-right">
//                                         <div className="font-semibold">For, <span className="font-bold"><p>For {companyData?.companyName}</p></span></div>
...
export default async function Page({
  ...
  return <PreviewInvoice invoiceId={resolvedParams.id} />;
}