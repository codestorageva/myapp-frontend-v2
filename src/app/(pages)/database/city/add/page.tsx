...
const CityAddUpdate = () => {
    ...
    async function onSumbit(values: AddCityParams, { resetForm }: { resetForm: () => void }) {
        setIsLoading(true);
        try {
    ...
    return (
        <div className='w-full flex flex-col items-center  p-5'>
            ...
            <h1 className="text-3xl font-bold text-center text-black mb-10 mt-10">{'Add New'} City</h1>
