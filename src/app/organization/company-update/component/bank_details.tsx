        ...
        <div className='w-full'>
            <div className='mt-5 grid grid-cols-3 gap-x-4 gap-y-3 mb-3'>
                ...
                <div className='sm:col-span-1'>
                    ...
                    <div className='mt-1'>
                        <input type='text' name='IFSC' value={values.IFSC} maxLength={11} onChange={handleChange} className="block w-full font-inter rounded-md border focus:outline-none border-gray-300 py-1 px-2 text-gray-900 focus:border-blue-500 focus:border-[2px] placeholder:text-gray-400 sm:text-sm sm:leading-6" />
