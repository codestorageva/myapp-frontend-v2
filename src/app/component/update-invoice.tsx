                            ...
                            <Form>
                                <div>
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div className='col-span-1'>
                                            <TextField label='Transport' name='transport' type='text' value={values.transport} onChange={handleChange} />
                                        </div>
                                        <div className='col-span-1'>
                                            <TextField label='Range' name='range' type='text' value={values.range} onChange={handleChange} />
                                        </div>
                                        <div className='col-span-1'>
                                            <TextField label='Division' name='division' type='text' value={values.division} onChange={handleChange} />
                                        </div>
                                        <div className='col-span-1'>
                                                            ...
                                                            <React.Fragment key={idx}>
                                                                ...
                                                                {miningRows.map((mRow, i) => (
                                                                    <tr key={i} className="">
                                                                        ...
                                                                        <td className='p-2 text-right'>
                                                                            <div className='border rounded px-2 py-1'>
                                                                                ₹ {mRow.value.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                ))}
