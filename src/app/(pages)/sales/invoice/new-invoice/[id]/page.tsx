...
import NewInvoice from "@/app/component/InvoiceView";
...
//                         <p className='border-r w-2/3 p-2'>Terms & Conditions : <br />
//                             {data?.customer.terms}
//                         </p>
//                         <div className="text-right w-1/3 p-2">
...
export default async function Page({
  ...
  return <NewInvoice invoiceId={resolvedParams.id} />
}
